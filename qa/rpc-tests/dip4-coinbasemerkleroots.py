...
from test_framework.test_framework import CryptoncoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(CryptoncoinTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as CryptoncoinTestFramework doesn't support this atm)
