...
official/supported Docker Images found at https://hub.docker.com/r/cryptoncoinpay/cryptoncoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/cryptoncoinpay/cryptoncoind-develop/ when changing the above text**