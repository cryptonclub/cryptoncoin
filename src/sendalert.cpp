...
2. run cryptoncoind with -printalert or -sendalert like this:
   /path/to/cryptoncoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cryptoncoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Cryptoncoin Core:0.12.0.58/"));
