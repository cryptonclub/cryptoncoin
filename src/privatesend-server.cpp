...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Cryptoncoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Cryptoncoin and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Cryptoncoin specific functionality
