 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1579365913, nBits=1e0ffff0, nNonce=257946, vtx=1)
...
{
    const char* pszTimestamp = "An 11 year old girl was rescued hours after an Amber Alert";
    const CScript genesisOutputScript = CScript() << ParseHex("0441a64c3e5957c8e7e5698c5144167a76c503e13babbe415ffa7fbf7fc707db64b0382fe6f0f85b008e531aa3bcb027efac65bcc604555e90f73df76050c3b083") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000fc67dbd56effc5837680d87d1e1cd920df202c73917ac3a461272665717"); 
        ...
        vAlertPubKey = ParseHex("042ecc2c10416b87d302635a90869a36a29656a44e54eca6b41dcd7ba23e8bad8fdab4dd9b99dc0436ce885f5073269fc4fcbb8741fe59bb6c7d3c0d30a4d712aa");
        nDefaultPort = 15534;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1579365913, 257946, 0x1e0ffff0, 1, 50 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000fc67dbd56effc5837680d87d1e1cd920df202c73917ac3a461272665717"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc591e151868352f29779b2029d34472bd7afa367aeec028d887f9275494d90a"));


        vSeeds.push_back(CDNSSeedData("cryptonclub.com", "node1.cryptonclub.com"));
        vSeeds.push_back(CDNSSeedData("n2.cryptonclub.com", "node2.cryptonclub.com"));
        ...
        // Cryptoncoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Cryptoncoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Cryptoncoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"CWdMcWSPY67x7iZGehUPewgE2rvyqoYJUv"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000fc67dbd56effc5837680d87d1e1cd920df202c73917ac3a461272665717"))
        };

        chainTxData = ChainTxData{
            1579365913, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000009caad66997cfca771e03db69cf07c10b9ba6d853d8db6834caf914f9702"); 

        pchMessageStart[0] = 0x59;
        pchMessageStart[1] = 0x38;
        pchMessageStart[2] = 0x3d;
        pchMessageStart[3] = 0xb0;
        vAlertPubKey = ParseHex("04684c9f30c45135ce47442513363ddd85e96b19f17f32868dc597066f3533ce7ccb6ac718907b7326099ae5fdf9b1d98b6c0caf8e2eeb1a935950bf3d72f86fac");
        nDefaultPort = 25534;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1579365918UL, 833272UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000009caad66997cfca771e03db69cf07c10b9ba6d853d8db6834caf914f9702"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc591e151868352f29779b2029d34472bd7afa367aeec028d887f9275494d90a"));
        ...
        // Testnet Cryptoncoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Cryptoncoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Cryptoncoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"DSNQWknEFWyBmdsLrWa2qjQ7D5nGwrMpV7"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000009caad66997cfca771e03db69cf07c10b9ba6d853d8db6834caf914f9702"))
        };

        chainTxData = ChainTxData{
            1579365918, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1579365923, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x2313da37c5f921f114ea4100f1dfd3784b65ad4553cff5c7db2b2e934f7217fe"));
        assert(genesis.hashMerkleRoot == uint256S("0xdc591e151868352f29779b2029d34472bd7afa367aeec028d887f9275494d90a"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("cryptoncoinevo.org",  "devnet-seed.cryptoncoinevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x2313da37c5f921f114ea4100f1dfd3784b65ad4553cff5c7db2b2e934f7217fe"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6L3J4kSF6duADDW3EqSuVVaYRoSQKS9W5wP1ajvx3tFcKciKTSK
        vSporkAddresses = {"DQhjBxgtZKEqA2VZEvfZjatMiSpp2feAF6"};
        nMinSporkKeys = 1;
        ...
        // Regtest Cryptoncoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        // Regtest Cryptoncoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,31);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // Regtest Cryptoncoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Cryptoncoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Cryptoncoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
