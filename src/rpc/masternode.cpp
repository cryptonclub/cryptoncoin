...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Cryptoncoin address\n"
            "  payee          - Print the masternode payout Cryptoncoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Cryptoncoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "cryptoncoin",               "masternode",             &masternode,             true,  {} },
    { "cryptoncoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "cryptoncoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "cryptoncoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
