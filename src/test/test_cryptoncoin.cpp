...
#define BOOST_TEST_MODULE Cryptoncoin Test Suite

#include "test_cryptoncoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_cryptoncoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
