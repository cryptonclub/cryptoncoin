...
//! These need to be macros, as clientversion.cpp's and cryptoncoin*-res.rc's voodoo requires it
...
/**
 * cryptoncoind-res.rc includes this file, but it cannot cope with real c++ code.
