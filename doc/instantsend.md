...
This mechanism has been integrated into Bitcore-Node-Cryptoncoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cryptoncoinpay/insight-api-cryptoncoin#web-socket-api](https://github.com/cryptoncoinpay/insight-api-cryptoncoin#web-socket-api)
* API: [https://github.com/cryptoncoinpay/insight-api-cryptoncoin#instantsend-transactions](https://github.com/cryptoncoinpay/insight-api-cryptoncoin#instantsend-transactions)
