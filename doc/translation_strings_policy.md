...
This document provides guidelines for internationalization of the Cryptoncoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cryptoncoin_en.ts` remains unchanged.
