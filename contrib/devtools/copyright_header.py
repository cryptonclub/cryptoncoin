...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Cryptoncoin Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a Cryptoncoin Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Cryptoncoin Core developers'
...
Arguments:
    <base_directory> - The base directory of Cryptoncoin Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Cryptoncoin Core repository.
"""
